...
```
SYN Dataset ::: https://drive.google.com/drive/folders/1qTb6Ldr9XTDqubhmJFQzum-CgGl-YYmh?usp=sharing
...
Compose by editing the toggles. The "TopoFuse w/o topology" baseline is
...
Built strictly from run outputs (`train_log.jsonl`, `per_volume.csv`,
...
cod,; please cite the paper if you build on it.
